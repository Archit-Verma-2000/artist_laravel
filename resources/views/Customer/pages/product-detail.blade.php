                ...
                <div class="row">
                    <div class="col-md-6 slider-bar">
                        <div id="slider" class="owl-carousel product-slider">
                            <div class="item">
                                <img src="{{asset('Customer/images/shop-list.png')}}" />
                            </div>
                            <div class="item">
                                <img src="{{asset('Customer/images/rs-layer-wraprs-layer.png')}}" />
                            </div>
                            <div class="item">
                                <img src="{{asset('Customer/images/shop-list-img.png')}}" />
                            </div>
                            <div class="item">
                                <img src="{{asset('Customer/images/second.png')}}" />
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="product-dtl">
                            <div class="product-info">
                                <div class="product-name">Women Blazer</div>
                            ...
                            <div class="social-share">
                                <h3>Share at <span class="share"><i class="fa fa-share" aria-hidden="true"></i></span>
                                </h3>
                                <ul>
                                    <li>
                                        <a href="">
